...
const MenuContainerComponent = _constants.IS_IOS ? _expoBlur.BlurView : _reactNative.View;

const AnimatedView = _reactNativeReanimated.default.createAnimatedComponent(MenuContainerComponent);
...
const MenuListComponent = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(AnimatedView // @ts-ignore
  , {
    intensity: 100,
