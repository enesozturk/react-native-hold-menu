...
const HoldItemComponent = ({
  ...
  const calculateTransformValue = () => {
    ...
    if (!disableMove) {
      if (isAnchorPointTop) {
        const topTransform = itemRectY.value + itemRectHeight.value + menuHeight + _styleGuide.default.spacing * 2;
        tY = topTransform > height ? height - topTransform : 0;
      } else {
        const bototmTransform = itemRectY.value - menuHeight;
        tY = bototmTransform < 0 ? -bototmTransform + _styleGuide.default.spacing * 2 : 0;
      }
    }
  ...
  }, /*#__PURE__*/_react.default.createElement(PortalOverlay, null), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
      position: 'absolute',
      overflow: 'hidden',
      top: -20
    }
  }, attachedView), children))); //#endregion
};
