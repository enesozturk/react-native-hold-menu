...
import { View } from 'react-native'; //#region reanimated & gesture handler
...
const HoldItemComponent = ({
  ...
  const calculateTransformValue = () => {
    ...
    if (!disableMove) {
      if (isAnchorPointTop) {
        const topTransform = itemRectY.value + itemRectHeight.value + menuHeight + styleGuide.spacing * 2;
  ...
  }, /*#__PURE__*/React.createElement(PortalOverlay, null), /*#__PURE__*/React.createElement(View, {
    style: {
      position: 'absolute',
      overflow: 'hidden',
      top: -20
